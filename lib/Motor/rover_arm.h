...
// SHOULDER_SERVO
#define REG_KP_SHOULDER 4.0f
#define REG_KI_SHOULDER 0.3f
#define REG_KD_SHOULDER 0
#define REG_KP_SHOULDER_AGG 6.0f
#define REG_KI_SHOULDER_AGG 0.5f
