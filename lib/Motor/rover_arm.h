...
// SHOULDER_SERVO
#define REG_KP_SHOULDER 1.0f
#define REG_KI_SHOULDER 1.0f
#define REG_KD_SHOULDER 0.4f
#define REG_KP_SHOULDER_AGG 1.5f
#define REG_KI_SHOULDER_AGG 1.5f
#define REG_KD_SHOULDER_AGG 0.6f
